...
SPEC_DIGEST = "75504e4d9db21c6b371233616ba1bce979a1d9c8ad2f1cc271dd42be98a25d12"
...
# Sub-agents (notably the Coder) emit whole files inside one tool-call
# arguments blob; too small a cap truncates the JSON mid-write, which the
# provider reports as finish_reason="length" and yields unparseable args.
